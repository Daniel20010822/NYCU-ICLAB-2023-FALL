...
(iopad
    ...
    (right
		...
		(inst  name="I_SIZE0"	place_status=placed )
		(inst  name="I_SIZE1"	place_status=placed )
    ...
    (bottom
		...
		(inst  name="I_IDX3"	place_status=placed )
		(inst  name="I_IDX2"	place_status=placed )
		(inst  name="I_IDX1"	place_status=placed )
		(inst  name="I_IDX0"	place_status=placed )
    ...
    (left
		...
		(inst  name="I_INVLD"	place_status=placed )
		(inst  name="I_INVLD2"	place_status=placed )
