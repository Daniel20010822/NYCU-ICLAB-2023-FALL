...
/* Notes :
The following are the time stamps when first data appear.
When making any changes, MINUS 1.

1. CONV starts at 9, 104 last data
2. FEATURE MAP has 1 cycle delay. That is, first dat is not 10, but 11.

2.5 EQUALIZER (LINE458)
MAXPOOLING starts at 112

3. MAX POOLING at 49, 51, 57, 59 (First Page), 97, 99, 105, 107
4. FULLY CONNECT is at 107, 108, 109
5. NORMALIZE has 1 cycle delay. That is, not 110 111 112 113, but 111 112 113 114.
6. ACTIVIATION has 1 cycle delay. That is, not 114 115 116 117, but 115 116 117 118.
7. SUM4 is at 119, and will store into a DFF out_r
8. OUTVALID at 120
*/

// Changelog:
// 1. shift every procedure after 2nd page maxpool (using EQUALIZER_LATENCY)
// 2. modify the time of 1st page maxpool @530 531 532 533 740 746 752 758
